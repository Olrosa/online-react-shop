...
const ProductsListItem = (props) => {
    ...
    return (
        <div className='card flex-offer-col gap-20'>
            ...
            <button class='button'>To cart</button>
        </div>
    )
} 
